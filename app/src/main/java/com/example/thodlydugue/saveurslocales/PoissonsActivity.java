...
public class PoissonsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Poissons");
        ...
        queryBuilder.setWhereClause("id_categorie='AAE118AF-4D7B-719C-FF9B-3A22535EFE00'");
...
//Set up Method details view
        lvrecette.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(PoissonsActivity.this, DetailsActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                PoissonsActivity.this.setTitle(query);
                return true;
            }
