...
public class ViandesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //whereClause.append( ".objectId='" ).append( "E35F3B78-9E74-C3C6-FF4E-3DC4123BF500"  );
        ...
        queryBuilder.setWhereClause("id_categorie='E35F3B78-9E74-C3C6-FF4E-3DC4123BF500'");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                ViandesActivity.this.setTitle(query);
                return true;
            }
