...
//Setup toolbar and back button
        ...
        queryBuilder.setWhereClause("id_categorie='A7805A99-C650-E291-FF71-813C1D7F8F00'");
        setloading();
        ...
        lvrecette.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DessertsActivity.this, DetailsActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                DessertsActivity.this.setTitle(query);
                return true;
            }
    ...
    private void fetchdessert(String query) {
        lvrecette = (ListView) findViewById(R.id.lvrecette);
        listRecette = new ArrayList<>();
        adapterRecette = new ListviewrecetteAdapter(this, listRecette);
